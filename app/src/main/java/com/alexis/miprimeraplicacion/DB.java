...
public class DB extends SQLiteOpenHelper {
    ...
    private static final String SQLdb = "CREATE TABLE productos (idProducto TEXT, codigo TEXT, descripcion TEXT, marca TEXT, presentacion TEXT,precio TEXT, costo TEXT, ganancia TEXT, stock TEXT, urlFoto TEXT)";
    ...
    public String administrar_productos(String accion, String[] datos) {
        try{
            ...
            switch (accion) {
                case "nuevo":
                    sql = "INSERT INTO productos (idProducto,codigo, descripcion, marca, presentacion, precio,costo, ganancia, stock, urlFoto,urlFoto1,urlFoto2) VALUES ('"+ datos[0] +"','"+ datos[1] +"', '" + datos[2] + "', '" + datos[3] + "', '" + datos[4] + "', '" + datos[5] + "', '" + datos[6] + "', '" + datos[7] + "', '" + datos[8] + "', '" + datos[9] + "', '" + datos[10] + "', '" + datos[11] + "')";
                    break;
                case "modificar":
                    sql = "UPDATE productos SET codigo = '" + datos[1] + "', descripcion = '" + datos[2] + "', marca = '" + datos[3] + "', presentacion = '" + datos[4] + "', precio = '" + datos[5] + "', costo = '" + datos[6] + "', ganancia = '" + datos[7] + "', stock = '" + datos[8] + "', urlFoto = '" + datos[9] + "', urlFoto = '" + datos[10] + "', urlFoto2 = '" + datos[11] + "' WHERE idProducto = " + '"'+ datos[0] + '"';
                    break;
                case "eliminar":
