        ...
        try {
            ...
            if (cproductos.moveToFirst()) {
                ...
                do {
                    ...
                    jsonObject.put("ganancia", cproductos.getString(7));
                    jsonObject.put("stock", cproductos.getString(8));
                    jsonObject.put("foto", cproductos.getString(9));
                    jsonObject.put("foto1", cproductos.getString(10));
                    jsonObject.put("foto2", cproductos.getString(11));
